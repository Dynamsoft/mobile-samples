...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //init runtimeSettings with PublicRuntimeSettings
            ...
            settings.furtherModes.grayscaleTransformationModes[0] = EnumGrayscaleTransformationMode.GTM_INVERTED;
            mbarcodeReader.updateRuntimeSettings(settings);

            //init runtimeSettings with json string
...
//                    "            \"GrayscaleTransformationModes\":[\"GTM_INVERTED\"],\n" +
//                    "            \"DeblurLevel\":9\n" +
//                    "        }\n" +
//                    "    ],\n" +
