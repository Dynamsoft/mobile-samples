...
import com.dynamsoft.barcode.EnumBinarizationMode;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //init setting with mode argument
            mbarcodeReader.setModeArgument("BinarizationModes", 0, "BlockSizeX", "20");
            mbarcodeReader.setModeArgument("BinarizationModes", 0, "BlockSizeY", "20");
            mbarcodeReader.setModeArgument("BinarizationModes", 0, "EnableFillBinaryVacancy", "1");
            mbarcodeReader.setModeArgument("BinarizationModes", 0, "ThreshValueCoefficient", "10");
            //init setting with json string
