...
class  DbrManager: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate,DBRServerLicenseVerificationDelegate {
    ...
    init(license:String)
    {
        ...
        //Best Speed settings
        barcodeReader.initRuntimeSettings(with: "{\"Version\":\"3.0\",\"ImageParameterContentArray\":[{\"Name\":\"Test1\",\"FormatSpecificationNameArray\":[\"FP_1\"],\"ExpectedBarcodesCount\":0,\"MaxAlgorithmThreadCount\":4,\"BarcodeFormatIds\":[\"BF_ALL\"],\"LocalizationModes\":[\"LM_CONNECTED_BLOCKS\",\"LM_SCAN_DIRECTLY\",\"LM_STATISTICS\",\"LM_LINES\"],\"DeblurLevel\":9}],\"FormatSpecificationArray\":[{\"Name\":\"FP_1\",\"BarcodeFormatIds\":[\"BF_PDF417\",\"BF_QR_CODE\",\"BF_DATAMATRIX\"],\"MirrorMode\":\"MM_Both\"}],\"RegionDefinitionArray\":[{\"Name\":\"default\",\"MeasuredByPercentage\":1,\"Top\":0,\"Bottom\":100,\"Left\":0,\"Right\":100}]}", conflictMode: EnumConflictMode.overwrite, error: &err)
        //balance settings
        ...
        //Customize the size of the decoding region.
        let region = iRegionDefinition.init()
        region.regionLeft   = 25
        region.regionTop    = 25
        region.regionRight  = 75
        region.regionBottom = 75
