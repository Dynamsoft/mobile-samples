...
class  DbrManager: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate,DBRServerLicenseVerificationDelegate {
    ...
    init(license:String)
    {
        ...
        //BasicSettings
        barcodeReader.initRuntimeSettings(with: "{\"Version\":\"3.0\",\"ImageParameterContentArray\":[{\"Name\":\"BasicSettings\",\"FormatSpecificationNameArray\":[\"FP_1\"],\"ExpectedBarcodesCount\":1,\"MaxAlgorithmThreadCount\":4,\"BarcodeFormatIds\":[\"BF_ALL\"],\"LocalizationModes\":[\"LM_CONNECTED_BLOCKS\",\"LM_SCAN_DIRECTLY\",\"LM_STATISTICS\",\"LM_LINES\"],\"DeblurLevel\":9}],\"FormatSpecificationArray\":[{\"Name\":\"FP_1\",\"BarcodeFormatIds\":[\"BF_PDF417\",\"BF_QR_CODE\",\"BF_DATAMATRIX\"],\"MirrorMode\":\"MM_Both\"}]}", conflictMode: EnumConflictMode.overwrite, error: &err)
        //balance settings
...
//        settings.terminatePhase          = EnumTerminatePhase.phaseRecognized
...
//        settings.scaleDownThreshold      = 2048
//        settings.intermediateResultTypes = Int(EnumIntermediateResultType.contour.rawValue) | Int(EnumIntermediateResultType.lineSegment.rawValue) | Int(EnumIntermediateResultType.originalImage.rawValue) | Int(EnumIntermediateResultType.typedBarcodeZone.rawValue) | Int(EnumIntermediateResultType.predetectedRegion.rawValue)
//        settings.binarizationModes                            = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.localizationModes                            = [2, 16, 4, 8, 0, 0, 0, 0]
//        settings.furtherModes.colourConversionModes           = [1, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.grayscaleTransformationModes    = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.regionPredetectionModes         = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.imagePreprocessingModes         = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.textureDetectionModes           = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.textFilterModes                 = [2, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.barcodeColourModes              = [1, 0, 0, 0, 0, 0, 0, 0]
//        settings.furtherModes.barcodeComplementModes          = [0, 0, 0, 0, 0, 0, 0, 0]
//        settings.scaleUpModes                                 = [1, 0, 0, 0, 0, 0, 0, 0]
//        settings.textResultOrderModes                         = [1, 2, 4, 0, 0, 0, 0, 0]
//        settings.minBarcodeTextLength                         = 0
//        settings.minResultConfidence                          = 20
