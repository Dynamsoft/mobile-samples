...
class  DbrManager: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate,DBRServerLicenseVerificationDelegate {
    ...
    init(license:String)
    {
        ...
        //Read Barcode Confidence settings
        barcodeReader.initRuntimeSettings(with: "{\"Version\":\"3.0\",\"ImageParameterContentArray\":[{\"Name\":\"TestConfidence\", \"FormatSpecificationNameArray\":[\"FP_1\"],\"ExpectedBarcodesCount\":0,\"MaxAlgorithmThreadCount\":4,\"BarcodeFormatIds\":[\"BF_ALL\"],\"LocalizationModes\":[\"LM_CONNECTED_BLOCKS\",\"LM_SCAN_DIRECTLY\",\"LM_STATISTICS\",\"LM_LINES\"],\"DeblurLevel\":9}],\"FormatSpecificationArray\":[{\"Name\":\"FP_1\",\"BarcodeFormatIds\":[\"BF_ALL\"],\"MinResultConfidence\":60}]}", conflictMode: EnumConflictMode.overwrite, error: &err)
        //balance settings
        ...
        //Set the minimum confidence of the result
