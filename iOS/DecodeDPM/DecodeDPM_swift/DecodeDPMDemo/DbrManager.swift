...
class  DbrManager: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate,DBRServerLicenseVerificationDelegate {
    ...
    init(license:String)
    {
        ...
        settings!.barcodeFormatIds  = Int(EnumBarcodeFormat.DATAMATRIX.rawValue)
        
        // Localizes barcodes by groups of marks, for DPM codes.
        settings?.localizationModes = [32,0,0,0,0,0,0,0]
    ...
    func parametersInit()
    {
        ...
        barcodeFormat = Int(EnumBarcodeFormat.DATAMATRIX.rawValue)
        barcodeFormat2 = 0
